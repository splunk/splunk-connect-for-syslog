...
If you use a cloud destination, your provider might enforce Source/Destination IP checks. This will block traffic because to the original source IP is passed through. Disable this setting. 
