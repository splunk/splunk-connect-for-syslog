...
| SC4S_SOURCE_TLS_IW_SIZE            | 20000000           | Initial Window size for TLS connections.                                                                                                                                                                                                    |
| SC4S_SOURCE_TLS_FETCH_LIMIT        | 2000               | Number of events to fetch from server buffer at one time for TLS connections.                                                                                                                                                               |
| SC4S_SOURCE_UDP_SO_RCVBUFF         | -1 (default net.core.rmem_default value)           | Server buffer size in bytes. Make sure that the host OS kernel is configured [similarly](gettingstarted/quickstart_guide.md#sc4s-setup).                                                                                                    |
| SC4S_SOURCE_TCP_SO_RCVBUFF         | -1 (default net.core.rmem_default value)           | Server buffer size in bytes. Make sure that the host OS kernel is configured [similarly](gettingstarted/quickstart_guide.md#sc4s-setup).                                                                                                    |
| SC4S_SOURCE_TLS_SO_RCVBUFF         | -1 (default net.core.rmem_default value)           | Server buffer size in bytes. Make sure that the host OS kernel is configured [similarly](gettingstarted/quickstart_guide.md#sc4s-setup).                                                                                                    |
| SC4S_SOURCE_RFC5426_SO_RCVBUFF     | -1 (default net.core.rmem_default value)           | Server buffer size in bytes for syslog over UDP. Make sure that the host OS kernel is configured [similarly](gettingstarted/quickstart_guide.md#sc4s-setup).                                                                                |
| SC4S_SOURCE_RFC6587_SO_RCVBUFF     | -1 (default net.core.rmem_default value)           | Server buffer size in bytes for syslog over TCP. Make sure that the host OS kernel is configured [similarly](gettingstarted/quickstart_guide.md#sc4s-setup).                                                                                |
| SC4S_SOURCE_RFC5425_SO_RCVBUFF     | -1 (default net.core.rmem_default value)           | Server buffer size in bytes for syslog over TLS. Make sure that the host OS kernel is configured [similarly](gettingstarted/quickstart_guide.md#sc4s-setup).                                                                                |
...
| SC4S_SOURCE_LISTEN_TCP_SOCKETS     | 1                  | Number of kernel sockets per active TCP port, which configures multi-threading of the TCP input buffer in the kernel to prevent packet loss. Total TCP input buffer is the sum of SOCKETS x SO_RCVBUFF.                                    |
| SC4S_SOURCE_LISTEN_TLS_SOCKETS     | 1                  | Number of kernel sockets per active TCP with TLS port, which configures multi-threading of the TLS input buffer in the kernel to prevent packet loss. Total TLS input buffer is the sum of SOCKETS x SO_RCVBUFF.                          |
