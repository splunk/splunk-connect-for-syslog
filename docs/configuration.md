...
| SC4S_DEST_SPLUNK_HEC_TLS_CA_FILE | container path `/opt/syslog-ng/tls/server.pem` | Custom trusted cert file not the path is relative to the location in the container `/opt/syslog-ng/tls/` |
