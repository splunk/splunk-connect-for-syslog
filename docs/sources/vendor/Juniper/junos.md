...
| juniper_junos_fw          | juniper:junos:firewall:structured | netfw          | none          |
| juniper_junos_ids          | juniper:junos:firewall:structured | netids         | none          |
| juniper_junos_utm          | juniper:junos:firewall:structured | netfw         | none          |
| juniper_junos_idp          | juniper:junos:idp      | netids         | none          |
| juniper_junos_idp          | juniper:junos:idp:structured | netids         | none          |
| juniper_junos_aamw          | juniper:junos:aamw:structured | netfw         | none          |
| juniper_junos_secintel          | juniper:junos:secintel:structured | netfw         | none          |
