...
def test_defaultroute(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
...
@mark.skip()
def test_internal(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
    host = "{}-{}".format(random.choice(setup_wordlist), random.choice(setup_wordlist))
...
def test_fallback(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
    host = "{}-{}".format(random.choice(setup_wordlist), random.choice(setup_wordlist))
...
def test_metrics(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
...
def test_tz_guess(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
...
def test_tz_fix_hst(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
...
def test_tz_fix_ny(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
...
@mark.skip()
def test_check_utf8(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
    st = env.from_string(
