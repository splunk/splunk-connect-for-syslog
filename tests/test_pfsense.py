...
def test_pfsense_other(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
    host = "{}-{}".format(random.choice(setup_wordlist), random.choice(setup_wordlist))
...
def test_pfsense_syslogd(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
    host = "{}-{}".format(random.choice(setup_wordlist), random.choice(setup_wordlist))
