...
test_data_no_host = [
    r'{{ mark }}[{{date }} {{ avi_time }}: Avi-Controller: INFO: ] [dc-um-monitor.gen: reason: Syslog for Config Events occured] At 2020-04-07 15:32:09+00:00 event USER_AUTHORIZED_BY_RULE occurred on object dc-um-monitor.gen in tenant admin as User dc-um-monitor.gen was authorized by mapping rule user is member of groups "["dcnet-genericid-ro-arbac"]" and ignore user attribute values. {{ host }}'
]
