...
def test_cyberark_epv(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
    host = "{}-{}".format(random.choice(setup_wordlist), random.choice(setup_wordlist))
...
def test_cyberark_pta(record_property, setup_wordlist, setup_splunk_sdk, setup_sc4s):
    host = "{}-{}".format(random.choice(setup_wordlist), random.choice(setup_wordlist))
